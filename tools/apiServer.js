...
// server.post("/submitters/", function(req, res, next) {
//   const error = validateSubmitter(req.body);
//   if (error) {
...
//   if (!submitter.firstName) return "Firstname is required.";
//   if (!submitter.lastName) return "Lastname is required.";
//   if (!submitter.id) return "Id is required.";
//   return "";
// }
